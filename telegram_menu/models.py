...
import tzlocal
import validators
from telegram import InlineKeyboardButton, InlineKeyboardMarkup, KeyboardButton, ReplyKeyboardMarkup, WebAppInfo, Location
...
class BaseMessage(ABC):
    ...
    def gen_keyboard_content(self) -> ReplyKeyboardMarkup:
        ...
        for row in self.keyboard:
            ...
            for btn in row:
                    ##########################################################
                if btn.label =="KONUM GÖNDER":
                    button_array.append(KeyboardButton(text=btn.label,request_location=True))

                    ##########################################################
                elif btn.web_app_url and validators.url(btn.web_app_url):
